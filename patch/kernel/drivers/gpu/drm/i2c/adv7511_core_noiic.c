...
static const uint8_t hdmi_edid_default[] = {
	...
	0x26, 0xcd, 0xe4, 0x46, 0x50, 0x2d, 0x31, 0x01,
	0x1e, 0x11, 0x01, 0x03, 0x80, 0x21, 0x1b, 0x78, 
	0x2a, 0xae, 0xa5, 0xa6, 0x54, 0x4c, 0x99, 0x26,
	0x14, 0x50, 0x54, 0xbf, 0xef, 0x00, 0x81, 0x80, 
	0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
	0x01, 0x01, 0x01, 0x01, 0x81, 0xc0, 0x9e, 0x20, 	//byte7 0x9e //preferred timing mode
	0x00, 0x90, 0x51, 0x20, 0x1f, 0x30, 0x48, 0x80,
	0x36, 0x00, 0x51, 0x0e, 0x11, 0x00, 0x00, 0x1c, 
	0x00, 0x00, 0x00, 0xfc, 0x00, 0x56, 0x47, 0x41,	//byte0 0x00 //detailed timing 2
	0x0a, 0x0a, 0x0a, 0x0a, 0x0a, 0x0a, 0x0a, 0x0a, 
	0x0a, 0x0a, 0x00, 0x00, 0x00, 0xfd, 0x00, 0x37,	//byte3 0x00 //detailed timing 3
	0x4c, 0x1d, 0x52, 0x0e, 0x00, 0x0a, 0x20, 0x20, 
	0x20, 0x20, 0x20, 0x20, 0x00, 0x00, 0x00, 0xff,	//byte5 0x00 //detailed timing 4
	0x00, 0x35, 0x38, 0x36, 0x36, 0x37, 0x33, 0x30, 
	0x30, 0x30, 0x30, 0x30, 0x31, 0x0a, 0x00, 0x93,
};
				  ...
				  size_t len)
{
	...
	KER_LOG("block = %d,len = %d\n",block,len);

	memcpy(buf,hdmi_edid_default,len);
	return 0;
}
#else
static int adv7511_get_edid_block(void *data, u8 *buf, unsigned int block,
				  size_t len)
{
	...
	bufPrint = buf;
	printk(KERN_INFO"edid buf len = %d\n",len);
	for (i = 0; i < len; ++i){
		printk(KERN_INFO"0x%02x ",*bufPrint++);
	}
		       ...
		       struct drm_connector *connector)
{
	...
	unsigned int val;
	static bool hpd = true;
	int ret;

#ifdef ADV7511_NOT_EXIST
	val |= ADV7511_STATUS_HPD;
#else
...
static int adv7511_probe(struct i2c_client *i2c, const struct i2c_device_id *id)
{
	...
	if (ret)
		return ret;
	dev_dbg(dev, "Rev. %d\n", val);
	KER_LOG("ADV7511_REG_CHIP_REVISION = %d\n",val);
